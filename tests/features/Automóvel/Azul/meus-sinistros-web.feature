# language: pt
Funcionalidade:Validar funcionamento da tela Meus sinistros do Seguro Auto-Azul na versão web
    ...
    Contexto: Acesso a tela Meus sinistros
        ...
        Esquema do Cenário:CT05 - Valido container Minha franquia
            Quando o sistema recebe as informações da tela
            Então abaixo do botão "Abrir um novo sinistro" deverá existir o container contendo <titulo>, <valor>, <mensagem>, <link>
            Exemplos:
        ...
        Cenário:CT07 - Valido botão "Abrir um novo sinistro"
            ...
            E foi exibido o botão "Abrir um novo sinistro" à direita as informações da apólice
        ...
        Regra: Apólice com sinistros em aberto
            ...
            Esquema do Cenário:CT11 - Valido modal "Telefones Porto Seguro"
                ...
                E na parte inferior direita do formulário deverá existir o botão "Voltar"
