# language: pt
Funcionalidade: Validar funcionamento do modal Selecionar apólice do Seguro Auto-Itaú

    Contexto:Acesso a funcionalidade Seguro Auto-Itaú
        Dado que o usuário se autenticou no PDC
        E possui mais de uma apólice ativa de Seguro Auto-Itaú
        ...
        Regra:Mobile - Valido funcionamento do scroll ao ultrapassar "9" itens no mobile
            Esquema do Cenário:CT03 - Valido funcionamento do scroll
                Dado que o usuário possui mais de "9" apólices ativas de "Seguro Auto-Itaú"
        ...
        Regra:Web - Valido funcionamento do scroll ao ultrapassar "8" itens na web
            Esquema do Cenário:CT04 - Valido funcionamento do scroll
                Dado que o usuário possui mais de "8" apólices ativas de "Seguro Auto-Itaú"
