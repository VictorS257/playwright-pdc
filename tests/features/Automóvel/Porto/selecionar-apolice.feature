# language: pt
Funcionalidade: Validar funcionamento do modal Selecionar apólice do Seguro Automóvel

    Contexto:Acesso a funcionalidade Seguro Automóvel
        Dado que o usuário se autenticou no PDC
        E possui mais de uma apólice ativa de Seguro Automóvel
        ...
        Regra:Mobile - Valido funcionamento do scroll ao ultrapassar "9" itens no mobile
            Esquema do Cenário:CT03 - Valido funcionamento do scroll
                Dado que o usuário possui mais de "9" apólices ativas de "Seguro Automóvel"
        ...
        Regra:Web - Valido funcionamento do scroll ao ultrapassar "8" itens na web
            Esquema do Cenário:CT04 - Valido funcionamento do scroll
                Dado que o usuário possui mais de "8" apólices ativas de "Seguro Automóvel"
