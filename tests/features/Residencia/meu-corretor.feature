# language: pt
Funcionalidade: Validar funcionamento do modal Meu Corretor do Seguro Residência

    Contexto:Acesso a funcionalidade Meu Corretor
        Dado que o usuário se autenticou no PDC
        E nevegou até o produto "Seguro Residência"
        E clicou no link "Exibir contatos" disponível no container Meu Corretor
        ...
        Regra:Cliente com um produto
            Esquema do Cenário:CT03 - Valido exibição dos dados do corretor e de apólice
                ...
                Exemplos:
                    ...
                    | {icone-produto} | {produto-ramo} | {Rua}, {Numero} | (apolice-detalhes) | {>}              |
                Exemplos:
