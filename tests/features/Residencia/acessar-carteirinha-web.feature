# language: pt
Funcionalidade: Validar exibição das informações completas da carteirinha do Seguro Residência na versão web
    ...
    Contexto:Acesso a funcionalidade "Acessar carteirinha"
        ...
        Esquema do Cenário:CT05 - Valido exibição dos dados do Verso
            Quando o carregamento da página ocorre com sucesso
            Então alinhado à direita do formulário "Frente" deverá existir o formulário preenchido com o título "Verso" contendo <campo>, <dado>
            E abaixo do formulário deverá existir o botão "Conversar pelo WhatsApp"
            Exemplos:
                | campo                                    | dado                                                         |
        ...
        Esquema do Cenário:CT06 - Valido funcionamento do botão "Copiar número da apólice"
            ...
            Quando o usuário clica no botão "Copiar número da apólice"
        ...
        Cenário:CT08 - Valido funcionamento do botão Fale pelo WhatsApp
            Dado que o carregamento da página ocorreu com sucesso
