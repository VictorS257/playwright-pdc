# language: pt
Funcionalidade: Validar Página inicial do Seguro Residência na versão web
    ...
    Contexto:Acesso o produto "Seguro Residência"
        ...
        Esquema do Cenário:CT14 - Valido exibição dos dados da parcela atual
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT15 - Valido exibição das opções de Atalhos
            Quando o carregamento da página inicial ocorre com sucesso
            Então abaixo da lista horizontal de botões "Ações rápidas" deverá existir o componente scroll horizontal com o título "Atalhos" contendo <icone>, <mensagem>
            Exemplos:
                | icone                          | mensagem               |
        ...
        Esquema do Cenário:CT19 - Valido funcionamento da notificação de "Endosso"
            ...
            Então abaixo das opções de "Ações rápidas" deverá existir o container contendo <titulo>, <mensagem>, <link>
            E na parte superior direita do componente deverá existir o botão {x} que irá fechar o "dialog" 
            Exemplos:
                | titulo                    | mensagem                                                      | link                |
