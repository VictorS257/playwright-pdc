# language: pt
Funcionalidade: Validar funcionamento da funcionalidade de pagamento de parcela do Seguro Residência
    ...
    Contexto: Acesso a área financeira
        ...
        Esquema do Cenário:CT02 - Valido modal de seleção de meio de pagamento
            Dado que o usuário clicou no botão "Pagar" em alguma das parcelas em aberto
            ...
            E abaixo do dialog deverá existir a mensagem "Ao optar pelo Pix, a liberação da parcela acontece em instantes, Por boleto, pode levar até 2 dias."
            ...
            Exemplos:
                | icone       | mensagem                              |
                | ìcone-aviso | "O código Pix tem validade até hoje." |
        ...
        Esquema do Cenário:CT08 - Valido pagamento via pix 
            ...
            Quando clica no botão "Pagar"
            Então abaixo do título do modal deverá existir a mensagem "Para pagar, copie e cole o código na área de Pix do app do seu banco.\n{chave-pix}"
            E abaixo da mensagem deverão existir os <campos> com os <dados>
        ...
        Esquema do Cenário:CT11 - Valido botão "Copiar código Pix"
            Dado o usuário seleciona a opção "Pix" no botão do tipo select
            E clica no botão "Pagar"
            Quando clica no botão "Copiar código Pix"
            Então deverá ser apresentado o componente dialog contendo <icone>, <mensagem>, <botao>
            E o componente deverá ser fechado automaticamente após "2s"
            Exemplos:
                | icone           | mensagem                 | botao |
