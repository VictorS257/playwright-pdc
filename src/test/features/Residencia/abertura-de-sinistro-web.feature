# language: pt
Funcionalidade: Validar funcionamento da tela Abertura de sinistro do Seguro Residência na versão web
    ...
    Contexto: Acesos a tela Abertura de sinistro
        ...
        Cenário:CT04 - Valido tela "Data e local da ocorrência"
            Quando o sistema recebe as informações da tela
            Então abaixo componente breadcrumb deverá existir o título "Informe quando e onde aconteceu o sinistro"
            E abaixo do título deverá existir o container com título "Data" 
            ...
            E na parte inferior direita da tela deverá existir o botão "Continuar"

        Cenário:CT05 - Valido mensagem de "CEP incorreto"
        ...
        Cenário:CT06 - Valido campos obrigatórios
        ...
        Cenário:CT07 - Valido componente checklist
            Quando o sistema recebe as informações da tela
            Então na lateral superior direita deverá existir um checklist indicando a etapa atual do processo de abertura de sinistro
            E as etapas serão "Data e local da ocorrência", "Informações", "Confirmação"
        ...
        Esquema do Cenário:CT08 - Valido container informações da apólice
            Quando o sistema recebe as informações da tela
            Então abaixo do checklist deverá existir o formulário preenchido contendo <campo>, <dado>
            Exemplos:
                | campo            | dado                 |
        ...
        Cenário:CT09 - Valido exibição do container Meu Corretor
            Quando o sistema recebe as informações da tela
            Então abaixo do container informações da apólice deverá existir o container "Meu Corretor"

        Cenário:CT10 - Valido tela "Informações"
            ...
            E o checklist deverá ser atualizado de acordo com o preenchimento dos formulários

        Esquema do Cenário:CT11 - Valido formulário "Ocorrência"
            ...
            E abaixo do campo "Natureza do sinistro" deverá existir o botão do tipo select com a mensagem "Tem um orçamento prévio?" com as opções "Não", "Sim"
        ...
        Cenário:CT12 - Valido opção "Sim" no campo "Tem um orçamento prévio?"
        ...
        Esquema do Cenário:CT13 - Valido formulário "Dados bancários"
            Quando o usuário está na tela Informações
        ...
        Esquema do Cenário:CT14 - Valido formulário "Contato"
            Quando o usuário está na tela Informações
        ...
        Cenário:CT15 - Valido campos obrigatórios
            Dado que o usuário não preenche algum dos campos na tela "Informações"
            Então o campo não preenchido deverá assumir a cor vermelha
            E deverá ser exibido o {icone-aviso} à esquerda do botão {x}
            E abaixo do campo deverá ser exibida a mensagem "Campo obrigatório"

        Cenário:CT16 - Valido botão "Voltar" na tela de Informações
        ...
        Cenário:CT17 - Valido tela "Confirmação"
            ...
            E abaixo do formulário deverão existir os botões "Voltar", "Confirmar e solicitar sinistro"

        Cenário:CT18 - Valido botão "Voltar" na tela de Confirmação
            Dado que o usuário está na tela de Confirmação da solicitação
            Quando clica no botão "Voltar"
            Então deverá retornar à tela "Informações" com os dados preenchidos

        Cenário:CT19 - Valido tela de sucesso na abertura do sinistro
            ...
            E abaixo do subtítulo deverá existir o formulário preenchido com todos os dados informados nas telas "Data e local da ocorrência", "Informações"
            E abaixo do formulário deverão existir os botões "Voltar ao início", "Acompanhar solicitação"

        Cenário:CT20 - Valido botão "Voltar ao início" na tela de sucesso na abertura do sinistro
        ...
        Cenário:CT21 - Valido botão "Acompanhar solicitação" na tela de sucesso na abertura do sinistro
            Dado que o usuário está na tela de sucesso na abertura do sinistro
            Quando clica no botão "Acompanhar solicitação"
            Então deverá ser direcionado para o fluxo "meus-sinistros"
        
        Esquema do Cenário:CT22 - Valido mensagem de erro
