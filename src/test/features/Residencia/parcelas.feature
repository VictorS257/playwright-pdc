# language: pt
Funcionalidade: Validar funcionamento da tela Parcelas do Seguro Residência
    ...
    Contexto: Acesso a funcionalidade Parcelas
        ...
        Esquema do Cenário:CT05 - Valido exibição da Parcela destaque
        ...
        Esquema do Cenário:CT06 - Valido exibição da lista Todas as parcelas
        ...
        Esquema do Cenário:CT07 - Valido funcionamento do botão Ver todas as parcelas
        ...
        Cenário:CT08 - Valido funcionamento do contador de valor total do seguro
            Quando o sistema recebe as informações da tela
        ...
        Esquema do Cenário:CT09 - Valido funcionamento do container Costumer Satisfaction
            Quando o sistema recebe as informações da tela
        ...
        Regra: Visualização mobile
            Cenário:CT10 - Valido reorganização dos componentes ao utilizar visualização mobile
                Dado que o usuário está utlizando a visualização mobile
                Quando o sistema recebe as informações da tela
                Então os componentes "contador de valor total do seguro" e "container Costumer Satisfaction" deverão estar alinhados à direita das informações de apólice

        Regra: Pagamento com Cartão Porto
            Cenário:CT11 - Parcela com status vencida
            ...
            Cenário:CT12 - Parcela com status procesando
                Dado que a forma de pagamento cadastrada é Cartão Porto
            ...
            Cenário:CT13 - Parcela com status a vencer
                Dado que a forma de pagamento cadastrada é Cartão Porto
            ...
            Cenário:CT14 - Parcela com status futura
                Dado que a forma de pagamento cadastrada é Cartão Porto
        ...
        Regra: Pagamento com Débito automático
            Cenário:CT15 - Parcela com status vencida
            ...
            Cenário:CT16 - Parcela com status procesando
                Dado que a forma de pagamento cadastrada é Débito automático
                Quando a parcela está com status Processando
            ...
            Cenário:CT17 - Parcela com status a vencer
                Dado que a forma de pagamento cadastrada é Débito automático
                Quando a parcela está com status A vencer
            ...
            Cenário:CT18 - Parcela com status ordem não enviada
                Dado que a forma de pagamento cadastrada é Débito automático
            ...
            Cenário:CT19 - Parcela com status futura
                Dado que a forma de pagamento cadastrada é Débito automático
                Quando a parcela está com status Futura
        ...
        Regra: Pagamento com Boleto
            Cenário:CT20 - Parcela com status vencida
            ...
            Cenário:CT21 - Parcela com status procesando
                Dado que a forma de pagamento cadastrada é Boleto
                Quando a parcela está com status Processando
                Então a mensagem de aviso de status deverá ser "Processando pagamento da parcela. Se você já pagou, é só aguardar.\nA confirmação leva até 3 dias úteis após pagamento."
                E deverá ser habilitado o botão "Pagar parcela"

            Cenário:CT22 - Parcela com status a vencer
                Dado que a forma de pagamento cadastrada é Boleto
                Quando a parcela está com status A vencer
            ...
            Cenário:CT23 - Parcela com status futura
                Dado que a forma de pagamento cadastrada é Boleto
                Quando a parcela está com status Futura
                Então a mensagem de aviso de status deverá ser "O pagamento do seu seguro está cadastrado para a opção boleto."
                E deverá ser habilitado o botão "Pagar parcela"

        Regra: Pagamento com Outos cartões
            Cenário:CT24 - Parcela com status procesando
            ...
            Cenário:CT25 - Parcela com status a vencer
                Dado que a forma de pagamento cadastrada é Outros cartões
                Quando a parcela está com status A vencer
        ...
        Esquema do Cenário:CT27- Valido modal de detalhes da parcela
            ...
            E abaixo das da mensagem de status da parcela deverá existir o botão "Pagar"
            Exemplos:
        ...
        Esquema do Cenário:CT28 - Valido mensagem de erro
        ...
        Esquema do Cenário:CT29 - Valido mensagem de erro ao carregar contador de valor total do seguro
        ...
        Esquema do Cenário:CT30 - Valido mensagem de erro ao acessar detalhes da parcela
