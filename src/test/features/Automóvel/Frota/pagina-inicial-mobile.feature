# language: pt
Funcionalidade: Validar Página inicial do Seguro Auto-Frota na versão mobile
    ...
    Contexto:Acesso o produto "Seguro Auto-Frota"
        ...
        Cenário:CT04 - Valido exibição das informaões do segurado
        ...
        Esquema do Cenário:CT06 - Valido exibição da carteirinha
            Quando o carregamento da página inicial ocorre com sucesso
            Então abaixo das informações do segurado deverá existir o container "frente" contendo <campo>, <info>
            E abaixo do container "frente" deverá existir o container "verso" contendo <capo>, <info>
            Exemplos:
                | campo    | info                           |
                | "icone"  | {icone-produto}                |
                | "titulo" | {produto-nome}                 |
        ...
        Esquema do Cenário:CT07 - Valido exibição das opções de "Ações rápidas"
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT08 - Valido exibição das opções de Atalhos
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT09 - Valido funcionamento do scroll Mais Porto para você
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT10 - Valido funcionamento do Menu
        ...
        Esquema do Cenário:CT11 - Menu Apólices
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT12 - Menu Assistências
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário: CT13- Menu Sinistro
            Quando o carregamento da página inicial ocorre com sucesso
