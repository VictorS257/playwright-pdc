# language: pt
Funcionalidade: Validar exibição das informações completas da carteirinha do Seguro Auto-Itaú na versão mobile
    ...
    Contexto:Acesso a funcionalidade "Exibir carteirinha"
        ...
        E possui alguma apólice ativa de Seguro Auto-Itaú
