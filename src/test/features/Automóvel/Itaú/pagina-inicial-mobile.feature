# language: pt
Funcionalidade: Validar Página inicial do Seguro Auto-Itaú na versão mobile

    Contexto:Acesso o produto "Seguro Auto-Itaú"
        ...
        Esquema do Cenário:CT14 - Menu Apólices
            ...
            Exemplos:
                | botoesapolice          | icone-interativo |
                | Dados da Apólice       | {>}              |
