# language: pt
Funcionalidade: Validar Página inicial do Seguro Auto-Azul na versão web

    Contexto:Acesso o produto "Seguro Auto-Azul"
        ...
        Esquema do Cenário:CT06 - Menu Assistências
            Quando o carregamento da página inicial ocorre com sucesso
            E o usuário clica na opção Assistências do menu lateral
            Então deverá expandir a opção contendo <botao>, <icone-interativo>
            Exemplos:
                | botao                     | icone-interativo |
                | Solicitar sssistência     | {>}              |
                | Histórico de solicitações | {>}              |
                | Apoio jurídico            | {>}              |
                | Centros automotivos       | {>}              |
                        
        Esquema do Cenário: CT07 - Menu Sinistro
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Cenário:CT08 - Valido exibição das informaões da apólice
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Regra:Validar funcionamento do scroll de apólices quando o usuário possui mais de uma apólice ativa
            ...
            Cenário:CT10 - Valido tela de carregamento entre apólices
            ...
            Cenário:CT11 - Valido alteração de apólice
                Dado que foi exibido o scroll horizontal de apólices
                E o usuário seleciona uma apólice diferente da atual no componente
        ...
        Esquema do Cenário:CT12 - Valido exibição das informações resumidas da carteirinha
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT13 - Valido exibição das opções de "Ações rápidas"
            Quando o carregamento da página inicial ocorre com sucesso
            Então abaixo das informações resumidas da carteirinha deverá exisir o componente lista horizontal de botões com o título "Ações rápidas"
            ...
            Exemplos:
                ...
                | {icone-ver-apólice}         | Exibir apólice         | {>}              |
                | {icone-nova-assistencia}    | Nova assistência       | {>}              |
                | {icone-novo-aviso-sinistro} | Novo aviso de Sinistro | {>}              |

        Esquema do Cenário:CT14 - Valido exibição dos dados da parcela destaque
            Quando o carregamento da página inicial ocorre com sucesso
            Então ao lado direito das informações resumidas da carteirinha deverá existir o formulário preenchido com o título "Parcela {parcela-numero} de {total-parcelas}" contendo <valor>, <vencimento>, <botao>
            Mas caso {parcela-numero} seja igual a {total-parcelas} o título do formulário deverá ser "Sem parcelas futuras"
            Exemplos:
                | valor                 | vencimento                       | botao        |
                | "R$ "+{parcela-valor} | "Vence em "+{parcela-vencimento} | Ver Parcelas |

        Esquema do Cenário:CT15 - Valido exibição das opções de Atalhos
            Quando o carregamento da página inicial ocorre com sucesso
            Então abaixo da lista horizontal de botões "Ações rápidas" deverá existir o componente lista horizontal de botões com o título "Atalhos"
            ...
            Exemplos:
                ...
                | {icone-canais-atendimento}     | Canais de atendimento  |
                
        Esquema do Cenário:CT016 - Valido funcionamento do scroll Mais Porto para você
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT18 - Valido funcionamento da notificação de Acompanhamento de sinistro
            Dado que o usuário possui sinistro Auto com status "Em acompanhamento" vinculado à apólice
            Quando o carregamento da página inicial ocorre com sucesso
        ...
        Esquema do Cenário:CT19 - Valido funcionamento da notificação de Endosso
            ...
            Então abaixo das opções de "Ações rápidas" deverá existir o componente dialog contendo <titulo>, <mensagem>, <link>
            E na parte superior direita do componente deverá existir o botão {x} que irá fechar o dialog
            Exemplos:
                | titulo                    | mensagem                                                     | link                |
