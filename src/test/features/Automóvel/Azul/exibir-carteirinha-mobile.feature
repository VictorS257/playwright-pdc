# language: pt
Funcionalidade: Validar exibição das informações completas da carteirinha do Seguro Auto-Azul na versão mobile

    Contexto:Acesso a funcionalidade "Ver carteirinha"
        ...
        E selecionou a opção "Ver carteirinha"
        ...
        Esquema do Cenário:CT05 - Valido exibição dos dados do Verso
            Quando o carregamento da página ocorre com sucesso
            Então abaixo do formulário frente deverá existir o formulário preenchido contendo <campo> <dado>
            Exemplos:
                | campo                                    | dado                                                         |
        ...
        Esquema do Cenário:CT08 - Valido funcionamento do botão "Fale pelo WhatsApp"
            Dado que o carregamento da página ocorreu com sucesso
            Quando o usuário clica no componente botão contendo <mensagem>, <icone>
